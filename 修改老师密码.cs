...
namespace 用户登录
{
    public partial class 修改老师密码 : Form
    {
        String str;
        public 修改老师密码()
        {
        ...
        {
            SqlCommand cmd = new SqlCommand("update teacher set tcode ='" + textBox1.Text.Trim() + "' where tno='" + str + "'", CreateSqlConn.con);
